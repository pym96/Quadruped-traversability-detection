...
startPos = [0.2, 0.5, 0.0];  % Start: bottom of stairs, centered
endPos = [2.0, 0.5, 0.6];    % End: top of stairs, centered
...
% Show original vs optimized path
